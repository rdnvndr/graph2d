...
GtkWidget* create_main_window(void)
{
   ...
   gtk_object_set_data (GTK_OBJECT(main_window), "statusbar",main_statusbar);
   gtk_box_pack_end(GTK_BOX(main_vbox),main_statusbar,FALSE,FALSE,0);
   gtk_statusbar_push(GTK_STATUSBAR(main_statusbar),1,"Добро пожаловать в Graph2D");
   gtk_widget_show(main_statusbar);
   
   menu_handlebox=gtk_handle_box_new();
   gtk_box_pack_start(GTK_BOX(main_vbox),menu_handlebox,FALSE,TRUE,0);
   ...
   gtk_container_add(GTK_CONTAINER(main_menu),item);
   gtk_signal_connect (GTK_OBJECT (item), "activate",
                      GTK_SIGNAL_FUNC (on_saveas_dialog),
                      NULL);
   gtk_widget_show(item);
   ...
   gtk_widget_add_accelerator(item, "activate",accel_group,
                              ...
                              GTK_ACCEL_VISIBLE);
   gtk_signal_connect (GTK_OBJECT (item), "activate",
                      GTK_SIGNAL_FUNC (on_close_main_window),
                      NULL);
   gtk_widget_show(item); 
   ...
   &style->bg[GTK_STATE_NORMAL],(gchar **)open_xpm);
   ...
   button = gtk_toolbar_append_element (GTK_TOOLBAR (toolbar),
                                ...
                                "Открыть",
                                "Открыть", NULL,
                                tmp_toolbar_icon,GTK_SIGNAL_FUNC (on_open_dialog),
				 NULL);
   
   gtk_widget_show (button);
  
   pixmap = gdk_pixmap_create_from_xpm_d(main_window->window,&mask,
   &style->bg[GTK_STATE_NORMAL],(gchar **)save_xpm);
   tmp_toolbar_icon= gtk_pixmap_new(pixmap,mask);
   gdk_pixmap_unref(pixmap);
   gdk_bitmap_unref (mask);
   button = gtk_toolbar_append_element (GTK_TOOLBAR (toolbar),
                                ...
                                "Сохранить",
                                "Сохранить",NULL,
                                tmp_toolbar_icon,GTK_SIGNAL_FUNC (on_save_dialog),
				 NULL);
   ...
   pixmap = gdk_pixmap_create_from_xpm_d(main_window->window,&mask,
   &style->bg[GTK_STATE_NORMAL],(gchar **)pal_xpm);
   tmp_toolbar_icon= gtk_pixmap_new(pixmap,mask);
   gdk_pixmap_unref(pixmap);
   gdk_bitmap_unref (mask);
   button = gtk_toolbar_append_element (GTK_TOOLBAR (toolbar),
                                ...
                                "Палитра",
                                "Палитра",NULL,
                                tmp_toolbar_icon,GTK_SIGNAL_FUNC (on_pal_dialog),
				 NULL);
   ...
   pixmap = gdk_pixmap_create_from_xpm_d(main_window->window,&mask,
   &style->bg[GTK_STATE_NORMAL],(gchar **)zoomin_xpm);
   tmp_toolbar_icon= gtk_pixmap_new(pixmap,mask);
   gdk_pixmap_unref(pixmap);
   gdk_bitmap_unref (mask);
   button = gtk_toolbar_append_element (GTK_TOOLBAR (toolbar),
                                ...
                                "Увеличить",
                                "Увеличить",NULL,
                                tmp_toolbar_icon,GTK_SIGNAL_FUNC (on_zoomin),
				NULL);
   ...
   pixmap = gdk_pixmap_create_from_xpm_d(main_window->window,&mask,
   &style->bg[GTK_STATE_NORMAL],(gchar **)zoomout_xpm);
   tmp_toolbar_icon= gtk_pixmap_new(pixmap,mask);
   gdk_pixmap_unref(pixmap);
   gdk_bitmap_unref (mask);
   button = gtk_toolbar_append_element (GTK_TOOLBAR (toolbar),
                                ...
                                "Уменьшить",
                                "Уменьшить",NULL,
                                tmp_toolbar_icon,GTK_SIGNAL_FUNC (on_zoomout),
				NULL);
   ...
   pixmap = gdk_pixmap_create_from_xpm_d(main_window->window,&mask,
   &style->bg[GTK_STATE_NORMAL],(gchar **)setka_xpm);
   tmp_toolbar_icon= gtk_pixmap_new(pixmap,mask);
   gdk_pixmap_unref(pixmap);
   gdk_bitmap_unref (mask);
   button_s = gtk_toolbar_append_element (GTK_TOOLBAR (toolbar),
                                ...
                                "Сетка",
                                "Сетка", NULL,
                                tmp_toolbar_icon,GTK_SIGNAL_FUNC (on_button_setka),
				 NULL);
   ...
   pixmap = gdk_pixmap_create_from_xpm_d(main_window->window,&mask,
   &style->bg[GTK_STATE_NORMAL],(gchar **)epsilon_xpm);
   tmp_toolbar_icon= gtk_pixmap_new(pixmap,mask);
   gdk_pixmap_unref(pixmap);
   gdk_bitmap_unref (mask);
   button_d = gtk_toolbar_append_element (GTK_TOOLBAR (toolbar),
                                ...
                                "Деформации",
                                "Деформации", NULL,
                                tmp_toolbar_icon,GTK_SIGNAL_FUNC (on_button_def),
				NULL);
   ...
   pixmap = gdk_pixmap_create_from_xpm_d(main_window->window,&mask,
   &style->bg[GTK_STATE_NORMAL],(gchar **)sigma_xpm);
   tmp_toolbar_icon= gtk_pixmap_new(pixmap,mask);
   gdk_pixmap_unref(pixmap);
   gdk_bitmap_unref (mask);
   button_n = gtk_toolbar_append_element (GTK_TOOLBAR (toolbar),
                                ...
                                "Напряжения",
                                "Напряжения", NULL,
                                tmp_toolbar_icon,GTK_SIGNAL_FUNC (on_button_nap),
				NULL);
   ...
   pixmap = gdk_pixmap_create_from_xpm_d(main_window->window,&mask,
   &style->bg[GTK_STATE_NORMAL],(gchar **)elem_xpm);
   tmp_toolbar_icon= gtk_pixmap_new(pixmap,mask);
   gdk_pixmap_unref(pixmap);
   gdk_bitmap_unref (mask);
   button = gtk_toolbar_append_element (GTK_TOOLBAR (toolbar),
                                ...
                                "Элеиенты",
                                "Элеиенты", NULL,
                                tmp_toolbar_icon,GTK_SIGNAL_FUNC (on_button_elem),
				NULL);
   ...
   pixmap = gdk_pixmap_create_from_xpm_d(main_window->window,&mask,
   &style->bg[GTK_STATE_NORMAL],(gchar **)knot_xpm);
   tmp_toolbar_icon= gtk_pixmap_new(pixmap,mask);
   gdk_pixmap_unref(pixmap);
   gdk_bitmap_unref (mask);
   button = gtk_toolbar_append_element (GTK_TOOLBAR (toolbar),
                                ...
                                "Узлы",
                                "Узлы", NULL,
                                tmp_toolbar_icon,GTK_SIGNAL_FUNC (on_button_knot),
				NULL);
...
GtkWidget* create_about_dialog(void)
{
   ...
   about_pixmap = gdk_pixmap_create_from_xpm_d(about_dialog->window,&mask,
   ...
   gtk_box_pack_end(GTK_BOX(about_action_area),about_button,FALSE,FALSE,0);
...
GtkWidget *create_open_dialog(void)
{
   ...
   gtk_signal_connect (GTK_OBJECT (open_dialog), "delete_event",
                      GTK_SIGNAL_FUNC (on_open_dialog_delete),
                      NULL);	
  gtk_signal_connect (GTK_OBJECT (ok_button), "clicked",
                      GTK_SIGNAL_FUNC (on_open_dialog_ok),
                      NULL);
  gtk_signal_connect (GTK_OBJECT (cancel_button), "clicked",
                      GTK_SIGNAL_FUNC (on_open_dialog_cancel),
                      NULL);
...
GtkWidget *create_save_dialog(void)
{
   ...
   gtk_signal_connect (GTK_OBJECT (save_dialog), "delete_event",
                      GTK_SIGNAL_FUNC (on_save_dialog_delete),
                      NULL);	
  gtk_signal_connect (GTK_OBJECT (ok_button), "clicked",
                      GTK_SIGNAL_FUNC (on_save_dialog_ok),
                      NULL);
  gtk_signal_connect (GTK_OBJECT (cancel_button), "clicked",
                      GTK_SIGNAL_FUNC (on_save_dialog_cancel),
                      NULL);
...
GtkWidget *create_pal_dialog(void)
{
   ...
   gtk_signal_connect (GTK_OBJECT (open_dialog), "delete_event",
                      ...
                      NULL);	
  gtk_signal_connect (GTK_OBJECT (ok_button), "clicked",
                      GTK_SIGNAL_FUNC (on_pal_dialog_ok),
                      NULL);
  gtk_signal_connect (GTK_OBJECT (cancel_button), "clicked",
                      GTK_SIGNAL_FUNC (on_open_dialog_cancel),
                      NULL);
